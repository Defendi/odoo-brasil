...
try:
    from pytrustnfe.nfse.curitibana import xml_gerar_nfse
    from pytrustnfe.nfse.curitibana import gerar_nfse
    from pytrustnfe.nfse.curitibana import cancelar_nfse

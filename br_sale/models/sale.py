...
class SaleOrderLine(models.Model):
    ...
    @api.depends('cfop_id', 'icms_st_aliquota_mva', 'aliquota_icms_proprio',
                 ...
                 'icms_st_aliquota_reducao_base', 'ipi_reducao_bc', 'icms_benef',
        ...
        for line in self:
            ...
            if fpos:
                vals = fpos.map_tax_extra_values(
                    line.product_id, line.order_id.partner_id, False, False, False, analytic_id)
